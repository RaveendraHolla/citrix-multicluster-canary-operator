...
class CanaryTestCase(unittest.TestCase):
    ...
    def test_handle_multicluster_canary_crd(self, mock_calculate_health_score, mock_apply_gtp, mock_read_gtp):
        ...
        assert(canary.handle_multicluster_canary_crd(canary_dict) is False)
